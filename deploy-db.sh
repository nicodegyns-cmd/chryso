...
# Create db.js with proper OVH PostgreSQL defaults
cat > /home/ubuntu/chryso/services/db.js << 'EOFDB'
...
function createPool() {
  ...
  if (!DATABASE_URL) {
    ...
    console.log('[DB INIT] Using OVH PostgreSQL defaults')
  }
...
echo "db.js created successfully"
