  ...
  try{
    ...
    if (!updated.invoice_number){
      try{
        ...
        await pool.query('UPDATE prestations SET invoice_number = $1 WHERE id = $2', [newInv, id])
    ...
    if (!updated.request_ref){
      try{
        ...
        await pool.query('UPDATE prestations SET request_ref = $1 WHERE id = $2', [newReq, id])
