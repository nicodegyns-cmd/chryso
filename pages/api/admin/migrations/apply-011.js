...
const { getPool, query } = require('../../../../services/db')
  ...
  if (req.method === 'GET') {
    try {
      ...
      const result = await pool.execute(
        "SELECT column_name FROM information_schema.columns WHERE table_name = 'users' AND column_name = 'invitation_token' LIMIT 1"
      )
