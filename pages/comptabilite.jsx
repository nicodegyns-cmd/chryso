...
export default function ComptabilitePage() {
  ...
  // Open manual invoice modal and load users + analytics
  async function openManualInvoice() {
    ...
    try {
      ...
      setAllUsers((usersData.users || []).filter(u => u.is_active))
      setAllAnalytics(analyticsData.items || [])
    } catch (e) {
      console.error('Failed loading form data', e)
    }
  }
  ...
  async function submitManualInvoice() {
    ...
    try {
      ...
      // Refresh the list to show the new invoice
      fetchPrestations()
    } catch (err) {
              ...
              <div>
                ...
                <select
                  ...
                  onChange={e => {
                    ...
                    const sel = allAnalytics.find(a => String(a.id) === String(aid))
