...
-- Foreign key constraint: automatique désactivée pour l'exécution du runner.
-- Si tu veux ajouter la contrainte manuellement, exécute :
...
-- (Ajout volontaire évite les problèmes de parsing avec les runners automatisés.)
