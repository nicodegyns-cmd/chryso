...
const code = `const { Pool: PgPool } = require('pg')
...
function createPool() {
  ...
  console.log('[DB INIT] DATABASE_URL:', DATABASE_URL.substring(0, 80))
...
fs.writeFileSync('/home/ubuntu/chryso/services/db.js', code, 'utf8');
console.log('File created successfully at /home/ubuntu/chryso/services/db.js');
